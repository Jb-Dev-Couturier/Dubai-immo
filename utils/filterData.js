export const filterData = [
  ...
  {
    items: [
      { name: 'Par jour', value: 'daily' },
      { name: 'Par semaine', value: 'weekly' },
      { name: 'Par mois', value: 'monthly' },
      { name: 'Par an', value: 'yearly' },
    ],
    placeholder: 'Fréquence Loyer',
  ...
  },
  {
    items: [
      ...
      { name: 'Certifié', value: 'verified-score' },
